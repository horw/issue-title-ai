...
| `labels`           | Filter issues by specific labels (comma-separated). Only issues with at least one of the specified labels will be processed                                                   | None (process all issues)                                                       |
